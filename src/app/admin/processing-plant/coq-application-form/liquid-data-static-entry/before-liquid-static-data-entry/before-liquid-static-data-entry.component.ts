...
@Component({
  selector: 'app-before-liquid-static-data-entry',
  templateUrl: './before-liquid-static-data-entry.component.html',
  styleUrls: ['./before-liquid-static-data-entry.component.css'],
})
export class BeforeLiquidStaticDataEntryComponent implements OnInit, OnDestroy {
  ...
  private initForm() {
    this.form = getForm(ProductType.LIQUID, MeasurementType.STATIC, 'before');
