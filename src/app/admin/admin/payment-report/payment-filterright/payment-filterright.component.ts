...
@Component({
  selector: 'app-paymentfilterright',
  templateUrl: './payment-filterright.component.html',
  styleUrls: ['./payment-filterright.component.css'],
})
export class PaymentFilterrightComponent implements OnInit {
